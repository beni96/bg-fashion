...
import { ADMIN_ROUTES } from './modules/admin/router/admin.routes';
import { ADMIN_PREFIX } from './modules/admin/router/admin.routes.names';
...
const routes: Routes = [
  ...
  { path: ADMIN_PREFIX, children: ADMIN_ROUTES },
